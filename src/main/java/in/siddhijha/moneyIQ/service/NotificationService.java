       ...
       log.info("Job Started : sendDailyIncomeExpenseReminder()");
        ...
        for(ProfileEntity profile: profiles){
            String body = "Hi " + profile.getFullName() + ",<br><br>"
                    + "This is a friendly reminder to add your income and expenses for today in Money IQ.<br><br>"
                    + "<a href="+frontendUrl+" style='display:inline-block;padding:10px 20px;background-color:#4CAF50;color:#fff;text-decoration:none;border-radius:5px;font-weight:bold;'>Go to Money IQ</a>"
                    + "<br><br>Best regards,<br>Money IQ Team";
            ...
            for(ProfileEntity profile: profiles){
                ...
                if(!todayExpenses.isEmpty()){
                   StringBuilder table= new StringBuilder();
                    ...
                    table.append("</table>");
                    String body = "Hi "+profile.getFullName()+",<br/><br/> Here is a summary of your expenses for today:<br/><br/>"+table+"<br/><br/>Best regards,<br/>Money IQ Team";
